    ...
    <div>
      ...
      >
        <div className={`bg-white`}>
          <nav className="flex justify-center h-14">
            <div className="w-full self-center flex space-x-2" onMouseEnter={() => setTab(null)}>
              <div className="self-center">Logo</div>
              <Link
                href="#contact"
                className={`p-3 ${currentTab === 3 && 'border-b-2 border-black transition duration-300'}`}
              >
                <div className="flex" onMouseEnter={() => !isFocused && setTab(1)}>
                  <h4>สินค้า</h4>
                </div>
              </Link>
            </div>
      ...
      {!isFocused && (
        <div
          ...
          className={`bg-white z-20 fixed transition-all duration-300 transform ${
            currentTab ? 'opacity-100 scale-100' : 'opacity-0 scale-95'
      ...
      {!currentTab && (
        <div
          className={`bg-white w-full z-20 fixed transition-all duration-300 transform ${
